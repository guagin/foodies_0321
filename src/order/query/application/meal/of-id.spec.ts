...
import { MealOfIdUseCase } from "./of-id"
...
describe("meal of id", () => {
  it("should pass", async () => {
    ...
    const mealOfIdUseCase = new MealOfIdUseCase(repository)
  ...
  it("should failed for undefined", async () => {
    await mongoose.connect(process.env.mongo_url)
    const repository = new MongoMealViewRepository(mongoose.connection)
